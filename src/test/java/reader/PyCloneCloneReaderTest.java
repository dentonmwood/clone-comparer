...
public class PyCloneCloneReaderTest {
    ...
    public void testOne() throws IOException {
        ...
        assertEquals("test_user_notification.py", source1.getFilename());
        ...
        assertEquals("test_auth.py", source2.getFilename());
        ...
        assertEquals(162, source1.getStartLine());
        assertEquals(166, source1.getEndLine());
        assertEquals(1.0, source1.getWeight());
        source2 = (PyCloneSource) clone2.getSource2();
        assertEquals("github_utils.py", source2.getFilename());
        assertEquals(188, source2.getStartLine());
        assertEquals(192, source2.getEndLine());
        assertEquals(1.0, source2.getWeight());
    }
}
